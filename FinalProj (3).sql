...
CREATE TABLE `personalprescription` (
  ...
  CONSTRAINT `CK_ConcentrationMG` CHECK (((`ConcentrationMG` % 50) = 0))
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `personalprescription` VALUES (1,'John Doe','2023-08-01','Take 1 tablet twice a day',500),(2,'Jane Doe','2024-05-15','Take 2 tablets with food',250),(3,'Bob Smith','2023-12-31','Take 1 capsule every 6 hours',100),(4,'Alice Jones','2025-01-01','Take 1 tablet every day',200),(4,'John Dosde','2023-08-01','Take 1 tablet twice a day',550),(4,'John Dossde','2023-08-01','Take 1 tablet twice a day',600),(4,'John Dsossde','2023-08-01','Take 1 tablet twice a day',700),(5,'John Doe','2023-08-01','Take 1 tablet twice a day',500),(5,'Tom Williams','2024-06-30','Take 1 tablet as needed for pain',300);
...
-- Dump completed on 2023-04-26 23:19:13
